...
require(src..".Geometry.Curve")

require(src..".Geometry.Circle")

require(src..".Geometry.Conic0")
require(src..".Geometry.Conic1")
require(src..".Geometry.Conic2")

require(src..".Geometry.Triangle")

require(src..".Geometry.Model")
